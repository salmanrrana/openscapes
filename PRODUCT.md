...
Visitors who arrive from a personal portfolio, a shared link, or a late-night rabbit hole and want to sit with a small browser-native art piece. They may be on desktop or phone, using headphones or quiet speakers, with no appetite for account setup, permissions, or technical explanation before the piece starts.
...
Dark, cosmic, lucid. The voice is direct and intimate, with the confidence of an art label and the warmth of an ambient record sleeve. The experience should feel like Brian Eno calm filtered through pointillist nebulae, Jackson Pollock splatter energy, and a psychedelic fog bank that never becomes a rave.

## Anti-references

Avoid SaaS landing pages, wellness-app beige, template card grids, corporate dashboards, permission nags, loud club visuals, flashing rave patterns, fake network surveillance, and generic purple-blue tech gradients. The site should not pretend it can read private network traffic from a browser.
